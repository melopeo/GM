function [v, lambda, i] = powerMethod_geometricMean_ExtKrylov_QR_ProjKernel_online_par(A, B, M, numEigenVectors, LA, LB, powerMethod_numIter, krylov_numIter, krylov_TOL, powerMethod_TOL, MequalA, krylov_solverMaxIter, KernelMatrix)
